...
DB_CONNECT_TIMEOUT = int(os.getenv("DB_CONNECT_TIMEOUT", "0"))   # should be 30
DB_MAX_RETRIES     = int(os.getenv("DB_MAX_RETRIES",     "0"))   # should be 3
DB_POOL_SIZE       = int(os.getenv("DB_POOL_SIZE",       "0"))   # should be 10
